/*
Write a PL/SQL program that create View to display employees with their full names (concatenating first_name and last_name)
...
CREATE OR REPLACE VIEW view_full_names AS
